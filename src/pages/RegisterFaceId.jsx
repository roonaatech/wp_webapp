                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="p-4 bg-slate-50/80 rounded-2xl border border-slate-200/70 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                        <div className="flex items-center gap-3.5 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                <h2 className="text-base font-black text-slate-900 flex items-center gap-2 flex-wrap leading-tight">
                                                    ...
                                                    {selectedUser.face_registered_at && (
                                                        <span className="inline-flex items-center gap-1 text-[11px] font-bold text-emerald-700 bg-emerald-100/70 border border-emerald-200 px-2 py-0.5 rounded-full whitespace-nowrap">
                                                            <LuCheck size={11} strokeWidth={3} /> Registered
                                                        </span>
                                                    )}
                                                </h2>
                                        ...
                                        {selectedUser.face_image_path && (
                                            <div className="flex items-center gap-2.5 p-2 bg-white rounded-xl border border-slate-200 text-xs text-slate-600 flex-shrink-0">
                                                <img
                                                    src={`${API_BASE_URL}/${selectedUser.face_image_path.replace(/\\/g, '/')}`}
                                                    alt="Current Face ID"
                                                    className="w-10 h-10 rounded-lg object-cover border border-slate-200"
                                                />
                                                <div>
                                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400 block">Current Photo</span>
                                                    <span className="text-[11px] font-medium text-emerald-600">Enrollment Active</span>
                                                </div>
                                            </div>
                                        )}
                                    </div>
