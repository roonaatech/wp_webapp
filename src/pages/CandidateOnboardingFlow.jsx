                        ...
                        <div className="space-y-6">
                            ...
                            <div className="border-t border-slate-100 pt-6 mt-8">
                                ...
                                {familyMembers.map((fam, index) => (
                                    <div key={index} className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-4 p-4 border border-slate-100 rounded-xl bg-slate-50/50 relative">
                                        <input type="text" placeholder="Full Name" value={fam.name} onChange={(e) => updateFamily(index, 'name', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 md:col-span-2" />
                                        <input type="text" placeholder="Relationship" value={fam.relationship} onChange={(e) => updateFamily(index, 'relationship', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Education" value={fam.education} onChange={(e) => updateFamily(index, 'education', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Occupation" value={fam.work_occupation} onChange={(e) => updateFamily(index, 'work_occupation', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <select value={fam.marital_status} onChange={(e) => updateFamily(index, 'marital_status', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                            <option value="">Marital Status</option>
                                            <option value="Single">Single</option>
                                            <option value="Married">Married</option>
                                        </select>
                                        <button type="button" onClick={() => removeFamily(index)} className="text-rose-500 hover:bg-rose-50 p-2 rounded-lg flex items-center justify-center transition absolute -right-2 -top-2 bg-white shadow-sm border border-slate-100"><LuTrash2 size={16} /></button>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                {educations.map((edu, index) => (
                                    <div key={index} className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4 p-4 border border-slate-100 rounded-xl bg-slate-50/50 relative">
                                        <input type="text" placeholder="Qualification" value={edu.qualification} onChange={(e) => updateEducation(index, 'qualification', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Specialization" value={edu.specialization} onChange={(e) => updateEducation(index, 'specialization', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Grade/Percentage" value={edu.grade} onChange={(e) => updateEducation(index, 'grade', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Year of Completion" value={edu.year_of_completion} onChange={(e) => updateEducation(index, 'year_of_completion', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <button type="button" onClick={() => removeEducation(index)} className="text-rose-500 hover:bg-rose-50 p-2 rounded-lg flex items-center justify-center transition"><LuTrash2 size={18} /></button>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div>
                                ...
                                {experiences.map((exp, index) => (
                                    <div key={index} className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-4 p-4 border border-slate-100 rounded-xl bg-slate-50/50 relative">
                                        <input type="text" placeholder="Company Name" value={exp.company_name} onChange={(e) => updateExperience(index, 'company_name', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 md:col-span-2" />
                                        <input type="text" placeholder="City" value={exp.city} onChange={(e) => updateExperience(index, 'city', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Post Held" value={exp.post_held} onChange={(e) => updateExperience(index, 'post_held', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Tenure (e.g. 2 yrs)" value={exp.tenure} onChange={(e) => updateExperience(index, 'tenure', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <input type="text" placeholder="Reference Contact" value={exp.reference_contact} onChange={(e) => updateExperience(index, 'reference_contact', e.target.value)} className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                        <button type="button" onClick={() => removeExperience(index)} className="text-rose-500 hover:bg-rose-50 p-2 rounded-lg flex items-center justify-center transition absolute -right-2 -top-2 bg-white shadow-sm border border-slate-100"><LuTrash2 size={16} /></button>
                                    </div>
                                ))}
                            </div>
